...
public class ProductResourceTest {
    ...
    void setup() {
        ...
        productRepository.createProduct(fourth);
    ...
    public void testGetAllProductsEndpoint() {
        ...
        .when().get("/api/products").then().statusCode(200).body(
            "products.size()", is(4), 
